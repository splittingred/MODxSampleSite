...
<ul>
	...
	<li>
	   ...
	   Allows visitors to search only the pages you wish them to search. Uses Ajax to display results without loading a new page.
    </li>
	<li>
	   <strong>Powerful Navigation Builder.</strong>
	   Duplicate or build virtually any navigation system with our dynamic menu builder code. The menu above, for example.
	   <a href="[[~9]]">More about menu features</a>
	</li>
	<li>
	    <strong>Custom "page not found (404)" page.</strong>
	...
	<li>
	   <strong>Newest documents list.</strong>
	   Shows your visitor the most recently added pages (configurable).
	</li>
</ul>
<p><strong>To log into the MODx Control Panel and start customizing this site, point your browser to
    <a href="[[++manager_url]]">[[++manager_url]]</a>.</strong></p>